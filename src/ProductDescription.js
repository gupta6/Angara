        ...
        return (
            <div className={classes.productDescription}>
                ...
                <div className={classes.ReviewSection}>
                    <span className={classes.reviewStars}>&#9733; &#9733; &#9733; &#9733; &#9733;</span> <span className={classes.reviews}>164 Reviews</span>
                </div>
                <div className={classes.priceContainer}>
                    <div className={classes.priceSec}>
                        <div className={classes.newprice}>$3,104</div>
                        <div className={classes.oldprice}><strike>$3,449</strike></div>
                    </div>
                    ...
                    <div className={classes.emioption}>
                        ...
                        <div className={classes.emidropbox}>
                            ...
                            <div className={classes.dropbox}>
                                ...
                                10% Off + Free Jewelry Gift(s) with code FOREVER applicable on easy pay Installments as well
                                </div>  
